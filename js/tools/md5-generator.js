// MD5 Generator Tool - Pure JavaScript MD5 implementation
...
function copyResult() {
    const result = document.getElementById('md5Output').textContent;
    if (result) {
        copyToClipboard(result);
    } else {
        showToast('Generate a hash first!', 'warning');
    }
}
